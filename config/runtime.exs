...
#
#     PHX_SERVER=true bin/growthpush_router start
#
...
if config_env() == :dev do
  config :growthpush_router, GrowthPushRouterWeb.Endpoint,
    http: [
      ip: {127, 0, 0, 1},
      port: String.to_integer(System.get_env("MIX_PORT") || System.get_env("PORT") || "4000")
    ]
end
...
if config_env() == :prod do
  ...
  config :growthpush_router, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
