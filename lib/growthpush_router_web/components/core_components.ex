defmodule GrowthPushRouterWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GrowthPushRouterWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GrowthPushRouterWeb.Gettext, "errors", msg, opts)
    end
  end
